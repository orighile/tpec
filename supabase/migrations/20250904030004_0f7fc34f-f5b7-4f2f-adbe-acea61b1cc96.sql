...
-- Only event owners can view guest information (including emails and phone numbers)
...
-- Only event owners can add guests to their events
...
-- Only event owners can update their event guests
...
-- Only event owners can delete their event guests
