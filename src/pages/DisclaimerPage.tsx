        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="prose prose-lg mx-auto">
            ...
            <Card className="mb-8">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <h3 className="text-lg font-semibold text-foreground">Event Planning Services</h3>
                ...
                <h3 className="text-lg font-semibold text-foreground">Vendor Marketplace</h3>
                <ul className="list-disc pl-6 space-y-2">
            ...
            <Card className="mb-8">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <h3 className="text-lg font-semibold text-foreground">Budget Calculations</h3>
                <p>
                ...
                <h3 className="text-lg font-semibold text-foreground">Refund Policies</h3>
                <p>
            ...
            <Card className="mb-8">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <h3 className="text-lg font-semibold text-foreground">Website Availability</h3>
                <p>
                ...
                <h3 className="text-lg font-semibold text-foreground">Third-Party Links</h3>
                <p>
            ...
            <Card className="mb-8">
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                ...
                <div className="bg-muted p-4 rounded-lg">
                  <p><strong className="text-foreground">TPEC Events</strong></p>
